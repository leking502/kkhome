            ...
            <div className='container px-3 pb-[20px] md:mt-[50px] pt-20 md:pt-0'>
                ...
                <div className="dark:bg-slate-800 bg-blue-200 mt-5 rounded px-3 py-2">
                    ...
                    <List type={ListType.disc} className="mt-5">
                        <li><b>BLOG_CONSTANTS folder : </b> inside this we have our data.tsx file where we set our authors, navbar and other details and we have _ARTICLES_LIST.tsx file where we maintain our article list.</li>
